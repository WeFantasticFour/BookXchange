...
public class Constant {
    ...
    public static final String BIBKEYS = "?bibkeys=";
    public static final String BIBKEY = "";
    ...
    public static final String URL_GET_BOOK = GET_BOOK + BIBKEYS + BIBKEY + DETAILS + FORMAT;
}
